        ...
        M.cancelScroll = function (e) {
            ...
            if (u || t) {
                ...
                var n, o, a, m, r, d, f, h, p = x(O),
                    ...
                    v = L(),
                    w = 0,
                    S = (n = y, o = (a = s).speedAsDuration ? a.speed : Math.abs(n / 1e3 * a.speed), a.durationMax && o > a.durationMax ? a.durationMax : a.durationMin && o < a.durationMin ? a.durationMin : parseInt(o, 10)),
                    E = function (e, t) {
                ...
                0 === q.pageYOffset && q.scrollTo(0, 0), f = i, h = s, u || history.pushState && h.updateURL && history.pushState({ smoothScroll: JSON.stringify(h), anchor: f.id }, document.title, f === document.documentElement ? "#top" : "#" + f.id),
